...
export default class Appointment extends Component {
    ...
    async onConfirmAppointment() {
        const { AppointmentType,AppointmentTypeIndex, date, time, call_type, choosenDate, choosenTime } = this.state

        const formData = new FormData()
        formData.append('title', AppointmentType[AppointmentTypeIndex]?.name)
                ...
                [
                    {
                        ...
                        onPress: () => {
                            this.props.navigation.navigate('PaymentWebView', {
                                paymentUrl: responseJson.data.approvalUrl,
    ...
    renderItems(item) {
        ...
        return (
            <View key={id} style={{ backgroundColor: '#fff', borderRadius: 20, marginBottom: hp(2) }} >
                ...
                <View style={{
                    backgroundColor: '#D3F5F6', paddingVertical: hp(1), borderRadius: 20,
    ...
    render() {
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{
                    marginVertical: hp(2), backgroundColor: '', flexDirection: "row",
                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        borderWidth: 2, borderColor: colors.themeColor, paddingVertical: 10, width: "48%",
                        alignItems: "center", justifyContent: "center",
                            ...
                            <View style={{ backgroundColor: '#fff', borderRadius: 15, marginBottom: hp(2) }} >
                                ...
                                <View style={{ paddingVertical: hp(4) }}>
                                    ...
                                    <View style={{
                                        ...
                                        {this.state.AppointmentType.map((item, index) => (
                                            <TouchableOpacity
                                            onPress={()=>this.setState({AppointmentTypeIndex:index})}
                                            style={{
                                                flexDirection: "row",
                                            }} key={item.id}>
                                                <View style={{
                                                    ...
                                                    marginHorizontal: 10,
                                                    borderWidth: 3,
                                                    borderColor: this.state.AppointmentTypeIndex == index ? "#116CAD" : "#000000"
                                                }}>
                                                    {
                                                        this.state.AppointmentTypeIndex == index ?
                                                            <View style={{
                                                                height: 10,
                                                                width: 10,
                                                                backgroundColor: "#116CAD",
                                                                borderRadius: 100,
                                                            }} />
                                                            :
                                                            null
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <TouchableOpacity onPress={() => this.setState({ option: 1, call_type: 1 })}
                                                ...
                                                <View style={{
                                                    ...
                                                    width: 20,
                                                     borderRadius: 100, 
                                                     borderColor: this.state.option === 1 ?
                                                        '#116CAD' : '#000000',
                                                        borderWidth:3,
                                                         margin: 5,
                                                          justifyContent: 'center',
                                                           alignItems: 'center',
                                                            ...
                                                            <View style={{ 
                                                                ...
                                                                height: 10,
                                                                borderRadius: 100,
                                                                backgroundColor: this.state.option === 1?'#116CAD':"#FFF" }} />
...
/> */}
                                                ...
                                                <Text style={{ color: this.state.option === 1 ? '#116CAD' : '#000000', fontSize: 14 }}>Phone Call Appointment</Text>
                                            </TouchableOpacity>
                                                ...
                                                <View style={{
                                                    height: 20,
                                                     margin: 5,
                                                      width: 20,
                                                       borderRadius: 50,
                                                       borderWidth:3,
                                                    borderColor: this.state.option === 2 ? 
                                                    '#116CAD' : '#000000',
                                                    justifyContent: 'center', alignItems: 'center'
                                                            ...
                                                            <View style={{ width: 10,
                                                                 height: 10,
                                                                  borderRadius: 100,
                                                                   backgroundColor:this.state.option === 2 ? '#116CAD': "#FFF" }} />
...
/> */}
                                                ...
                                                <Text style={{ color: this.state.option === 2 ? '#116CAD' : '#000000', fontSize: 14 }}>Video Call Appointment</Text>
                                            </TouchableOpacity>

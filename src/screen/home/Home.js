...
<TouchableOpacity  onPress={()=>this.selectTab(0)} style={{borderWidth:2,borderColor:colors.
...
<TouchableOpacity onPress={()=>this.selectTab(1)} style={{borderWidth:2,
...
<ScrollView  style={{marginBottom:hp(20)}} showsVerticalScrollIndicator={false}>

    {
      ...
      :
        ...
        <FormHistoryBox viewClick={this.viewAction.bind(this)} navigation={this.props.navigation} key={index} addAttachment={this.addAttachment.bind(this)} item={item}></FormHistoryBox>
        )
    }
   ...
   <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }}>
   {
        ...
        <SubFormHistoryBox closeModal={()=>this.setState({showSubTypeView:false})} viewClick={this.viewAction.bind(this)} navigation={this.props.navigation} key={index} addAttachment={this.addAttachment.bind(this)} item={item}></SubFormHistoryBox>
        )
    }
    </ScrollView>
</View>
